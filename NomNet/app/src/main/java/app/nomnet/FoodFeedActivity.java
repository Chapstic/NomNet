...
public class FoodFeedActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //if click nom on food feed, go to View CreateNom
    ...
    private void getNoms() {
        ...
        Bitmap[] images = {BitmapFactory.decodeResource(this.getResources(), R.drawable.food1),
                            BitmapFactory.decodeResource(this.getResources(), R.drawable.food2),
                            BitmapFactory.decodeResource(this.getResources(), R.drawable.food3),
                            BitmapFactory.decodeResource(this.getResources(), R.drawable.food4),
                            BitmapFactory.decodeResource(this.getResources(), R.drawable.food5)};
